...
export const routingComponents = {
  LoginComponent, HomeManagerComponent, HomeEmployeeComponent,
  SubmitReqComponent, EditUserComponent, ViewReqsComponent, ViewEmployeeReqsComponent, ViewEmployeesComponent
}